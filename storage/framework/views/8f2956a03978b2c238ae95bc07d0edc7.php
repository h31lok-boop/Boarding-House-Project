                ...
                <div class="flex items-center gap-2">
                    ...
                    <div class="relative" x-data="{open:false,confirm:false}">
                        <button @click="open=!open" class="flex items-center gap-2 px-2 py-1 rounded-full hover:bg-[color:var(--surface-2)]">
                            <img src="<?php echo e(asset('images/osas-avatar.png')); ?>" class="h-9 w-9 rounded-full object-cover" alt="OSAS">
...
<?php /**PATH C:\Users\Aiza\Documents\lesson 1\Boarding-House-Project\resources\views/components/osas/shell.blade.php ENDPATH**/ ?>