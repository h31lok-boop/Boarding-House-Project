...
<nav class="space-y-1 text-sm font-medium text-gray-700">
    <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <a
            ...
            class="flex items-center gap-2 px-3 py-2 rounded-lg border <?php echo e($isActive ? 'bg-sky-50 text-sky-800 border-sky-100' : 'border-transparent hover:bg-gray-50 text-gray-700'); ?>"
        >
...
<?php /**PATH C:\Users\Hazel\Herd\final-project\resources\views/components/sidebar/owner.blade.php ENDPATH**/ ?>