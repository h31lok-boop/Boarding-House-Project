            ...
            <tbody class="divide-y divide-slate-100">
                <?php $__currentLoopData = $validators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-slate-50">
                        <td class="px-4 py-3 font-semibold text-slate-900"><a href="<?php echo e($r('osas.validators.show',$v->id)); ?>" class="text-indigo-600 hover:underline"><?php echo e($v->name); ?></a></td>
                        <td class="px-4 py-3 text-slate-700"><?php echo e($v->email); ?></td>
                        ...
                        <td class="px-4 py-3 text-slate-700"><?php echo e($v->validationTasks()->count()); ?></td>
...
<?php endif; ?>
<?php /**PATH C:\Users\Aiza\Documents\lesson 1\Boarding-House-Project\resources\views/osas/validators.blade.php ENDPATH**/ ?>