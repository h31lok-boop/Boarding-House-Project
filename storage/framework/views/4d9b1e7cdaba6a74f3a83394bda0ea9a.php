            ...
            <div class="ui-card p-5">
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-2xl font-bold"><?php echo e($totalRooms); ?></p>
                    </div>
                    <div class="flex items-center gap-2 text-slate-600">
                        <?php echo $iconMap['rooms']; ?>
            ...
            <div class="ui-card p-5">
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-2xl font-bold"><?php echo e($totalHouses); ?></p>
                    </div>
                    <div class="flex items-center gap-2 text-slate-600">
                        <?php echo $iconMap['houses']; ?>
            ...
            <div class="ui-card p-5">
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-2xl font-bold"><?php echo e($pendingApplications); ?></p>
                    </div>
                    <div class="flex items-center gap-2 text-slate-600">
                        <?php echo $iconMap['applications']; ?>
      ...
      <div class="ui-card">
        <div class="p-6">
          ...
          <div class="space-y-2 text-sm">
            <a href="<?php echo e($r('admin.users')); ?>" class="block px-3 py-2 rounded-lg ui-surface-2 bg-[color:var(--surface)]">Manage Users</a>
            <a href="<?php echo e($r('admin.boarding-houses.index')); ?>" class="block px-3 py-2 rounded-lg ui-surface-2 bg-[color:var(--surface)]">Boarding Houses</a>
            <a href="<?php echo e($r('admin.applications.index')); ?>" class="block px-3 py-2 rounded-lg ui-surface-2 bg-[color:var(--surface)]">Applications</a>
            <a href="<?php echo e($r('admin.tenant-history')); ?>" class="block px-3 py-2 rounded-lg ui-surface-2 bg-[color:var(--surface)]">Tenant History</a>
          </div>
        </div>
      </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Aiza\Documents\lesson 1\Boarding-House-Project\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>