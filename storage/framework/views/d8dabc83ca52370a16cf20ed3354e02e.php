...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.profile-image-uploader','data' => ['label' => 'Profile','name' => 'profile_image','initial' => $profileImageUrl,'fallback' => asset('images/avatar-placeholder.svg'),'maxSizeKb' => '2048']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Profile','name' => 'profile_image','initial' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($profileImageUrl),'fallback' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(asset('images/avatar-placeholder.svg')),'max-size-kb' => '2048']); ?>
