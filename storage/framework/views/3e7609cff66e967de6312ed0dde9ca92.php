...
<?php endif; ?>
        ...
        <nav class="flex-1 space-y-4 text-sm sidebar-nav">
            <div>
                ...
                <a href="<?php echo e($r('caretaker.dashboard')); ?>" class="<?php echo e(request()->routeIs('caretaker.dashboard') ? $navActive : $navInactive); ?>">
                ...
                <a href="<?php echo e($r('caretaker.tenants.index')); ?>" class="<?php echo e(request()->routeIs('caretaker.tenants.*') ? $navActive : $navInactive); ?>">
                ...
                <a href="<?php echo e($r('caretaker.bookings.index')); ?>" class="<?php echo e(request()->routeIs('caretaker.bookings.*') ? $navActive : $navInactive); ?>">
            ...
            <div>
                ...
                <a href="<?php echo e($r('caretaker.rooms.index')); ?>" class="<?php echo e(request()->routeIs('caretaker.rooms.*') ? $navActive : $navInactive); ?>">
                ...
                <a href="<?php echo e($r('caretaker.maintenance.index')); ?>" class="<?php echo e(request()->routeIs('caretaker.maintenance.*') ? $navActive : $navInactive); ?>">
            ...
            <div>
                ...
                <a href="<?php echo e($r('caretaker.incidents.index')); ?>" class="<?php echo e(request()->routeIs('caretaker.incidents.*') ? $navActive : $navInactive); ?>">
            ...
            <div>
                ...
                <a href="<?php echo e($r('caretaker.notices.index')); ?>" class="<?php echo e(request()->routeIs('caretaker.notices.*') ? $navActive : $navInactive); ?>">
            ...
            <div>
                ...
                <a href="<?php echo e($r('caretaker.reports.index')); ?>" class="<?php echo e(request()->routeIs('caretaker.reports.*') ? $navActive : $navInactive); ?>">
                ...
                <a href="<?php echo e($r('caretaker.settings')); ?>" class="<?php echo e(request()->routeIs('caretaker.settings') ? $navActive : $navInactive); ?>">
                    ...
                    <div class="relative" x-data="{ open: false, confirm: false }">
                        ...
                        <div x-show="open" @click.outside="open = false" x-transition class="absolute right-0 mt-2 w-52 ui-surface rounded-xl shadow-lg border ui-border z-50">
                            <div class="px-4 py-3 border-b ui-border text-sm">
                                <p class="font-semibold"><?php echo e(auth()->user()->name ?? 'Caretaker'); ?></p>
                                <p class="text-xs ui-muted"><?php echo e(auth()->user()->email ?? ''); ?></p>
                            </div>
                            <div class="py-2 text-sm">
                                <a href="<?php echo e($r('caretaker.settings')); ?>" class="block px-4 py-2 hover:bg-[color:var(--surface-2)]">Settings</a>
...
<?php /**PATH C:\Users\Jay\Documents\GitHub\Boarding-House-Project\resources\views/components/caretaker/shell.blade.php ENDPATH**/ ?>