        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="field">
                ...
                <div class="input-wrap">
                    ...
                    <input id="name" name="name" type="text" placeholder="Enter your full name" value="<?php echo e(old('name')); ?>" required>
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="field">
                ...
                <div class="input-wrap">
                    ...
                    <input id="email" name="email" type="email" placeholder="Enter your email" value="<?php echo e(old('email')); ?>" required>
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="field">
                ...
                <div class="input-wrap">
                    ...
                    <input id="phone" name="phone" type="tel" placeholder="+1 (555) 123-4567" value="<?php echo e(old('phone')); ?>" required>
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="field tenant-only" data-tenant-only>
                ...
                <div class="input-wrap">
                    ...
                    <input id="institution_name" name="institution_name" type="text" list="institution-list" placeholder="Select or enter your institution" value="<?php echo e(old('institution_name')); ?>" data-requires="tenant">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="field tenant-only" data-tenant-only>
                ...
                <div class="input-wrap">
                    ...
                    <input id="move_in_date" name="move_in_date" type="date" value="<?php echo e(old('move_in_date')); ?>" data-requires="tenant">
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <label class="terms">
                <input type="checkbox" name="terms" value="1" <?php if(old('terms')): echo 'checked'; endif; ?> required>
                <span>
...
<?php /**PATH C:\Users\Hazel\Herd\final-project\resources\views/auth/register.blade.php ENDPATH**/ ?>