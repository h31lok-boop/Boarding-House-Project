            ...
            <?php $__currentLoopData = $metrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white shadow-sm sm:rounded-lg border border-gray-100 p-5">
                    <div class="flex items-start justify-between">
                        ...
                        <span class="text-xs font-semibold px-2 py-1 rounded-full bg-<?php echo e($metric['color']); ?>-100 text-<?php echo e($metric['color']); ?>-700">
                            <?php echo e($metric['delta']); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Hazel\Herd\final-project\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>