    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
      <div class="ui-card">
        <div class="p-6 border-b ui-border">
          <a href="<?php echo e(route('admin.users')); ?>" class="text-sm text-indigo-600 text-indigo-800">&larr; Back to Users</a>
        </div>
        <div class="p-6">
          <?php if($errors->any()): ?>
          ...
          <form method="POST" action="<?php echo e(route('admin.users.update', $user)); ?>" class="space-y-5">
            ...
            <div>
              ...
              <input name="name" value="<?php echo e(old('name', $user->name)); ?>" class="w-full border rounded-lg px-3 py-2 <?php echo e($viewOnly ? 'ui-surface-2 cursor-not-allowed' : ''); ?>" <?php echo e($viewOnly ? 'readonly' : ''); ?> required>
            </div>

            <div>
              <label class="block text-sm font-medium mb-1">Email</label>
              <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" class="w-full border rounded-lg px-3 py-2 <?php echo e($viewOnly ? 'ui-surface-2 cursor-not-allowed' : ''); ?>" <?php echo e($viewOnly ? 'readonly' : ''); ?> required>
            </div>

            <div>
              <label class="block text-sm font-medium mb-1">Phone</label>
              <input name="phone" value="<?php echo e(old('phone', $user->phone)); ?>" class="w-full border rounded-lg px-3 py-2 <?php echo e($viewOnly ? 'ui-surface-2 cursor-not-allowed' : ''); ?>" <?php echo e($viewOnly ? 'readonly' : ''); ?>>
            </div>

            <div>
              <label class="block text-sm font-medium mb-1">Role</label>
              <select name="role" class="border rounded-lg px-3 py-2 w-full <?php echo e($viewOnly ? 'ui-surface-2 cursor-not-allowed' : ''); ?>" <?php echo e($viewOnly ? 'disabled' : ''); ?>>
            ...
            <label class="inline-flex items-center gap-2 text-sm <?php echo e($viewOnly ? 'cursor-not-allowed' : ''); ?>">
