<?php
    $links = [
        ['label' => 'Dashboard', 'route' => 'caretaker.dashboard', 'icon' => '🧰', 'active' => 'caretaker.dashboard'],
...
<nav class="space-y-1 text-sm font-medium text-gray-700">
    <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <a
            ...
            class="flex items-center gap-2 px-3 py-2 rounded-lg border <?php echo e($isActive ? 'bg-amber-50 text-amber-800 border-amber-100' : 'border-transparent hover:bg-gray-50 text-gray-700'); ?>"
        >
...
<?php /**PATH C:\Users\Hazel\Herd\final-project\resources\views\components\sidebar\caretaker.blade.php ENDPATH**/ ?>