...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginalb731d514874952539462e12c5a6cf097 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb731d514874952539462e12c5a6cf097 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.sidebar.admin-panel','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('sidebar.admin-panel'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalb731d514874952539462e12c5a6cf097)): ?>
<?php $attributes = $__attributesOriginalb731d514874952539462e12c5a6cf097; ?>
<?php unset($__attributesOriginalb731d514874952539462e12c5a6cf097); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalb731d514874952539462e12c5a6cf097)): ?>
<?php $component = $__componentOriginalb731d514874952539462e12c5a6cf097; ?>
<?php unset($__componentOriginalb731d514874952539462e12c5a6cf097); ?>
<?php endif; ?>
    </aside>
                    ...
                    <div class="relative" x-data="{ open: false, confirm: false }">
                        ...
                        <div x-show="open" @click.outside="open = false" x-transition class="absolute right-0 mt-2 w-52 ui-surface rounded-xl shadow-lg border ui-border z-50">
                            <div class="px-4 py-3 border-b ui-border text-sm">
                                <p class="font-semibold"><?php echo e(auth()->user()->name ?? 'Admin'); ?></p>
...
<?php /**PATH C:\Users\Aiza\Documents\lesson 1\Boarding-House-Project\resources\views/components/admin/shell.blade.php ENDPATH**/ ?>