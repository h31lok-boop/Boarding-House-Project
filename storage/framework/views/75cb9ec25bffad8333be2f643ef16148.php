...
<div class="min-h-screen flex w-full">
    <aside class="w-[260px] shrink-0 h-screen sticky top-0 ui-surface border-r ui-border px-4 py-6 flex flex-col">
        <div class="mb-6 flex items-center gap-2">
            <div class="h-10 w-10 rounded-xl bg-gradient-to-br from-[#ff7e5f] via-[#feb47b] to-[#ffd1a3] text-white flex items-center justify-center font-bold">OS</div>
            <div class="leading-tight">
                <p class="text-sm font-semibold">OSAS Validator</p>
                <p class="text-xs ui-muted">Compliance</p>
            </div>
        </div>

        <nav class="flex-1 space-y-4 text-sm">
            <div>
                <p class="text-xs uppercase ui-muted mb-2">Validation</p>
                <a href="<?php echo e($r('osas.dashboard')); ?>" class="<?php echo e(request()->routeIs('osas.dashboard') ? $navActive : $navInactive); ?>">Dashboard</a>
                <a href="<?php echo e($r('osas.validators.index')); ?>" class="<?php echo e(request()->routeIs('osas.validators.*') ? $navActive : $navInactive); ?>">Validator Accounts</a>
                <a href="<?php echo e($r('osas.workbench')); ?>" class="<?php echo e(request()->routeIs('osas.workbench') ? $navActive : $navInactive); ?>">Validation Workbench</a>
                <a href="<?php echo e($r('osas.accreditation')); ?>" class="<?php echo e(request()->routeIs('osas.accreditation') ? $navActive : $navInactive); ?>">Accreditation Control</a>
                <a href="<?php echo e($r('osas.reports')); ?>" class="<?php echo e(request()->routeIs('osas.reports') ? $navActive : $navInactive); ?>">Reports / Monitoring</a>
            </div>
            <div>
                <p class="text-xs uppercase ui-muted mb-2">System</p>
                <a href="<?php echo e($r('osas.settings')); ?>" class="<?php echo e(request()->routeIs('osas.settings') ? $navActive : $navInactive); ?>">Settings</a>
            </div>
        </nav>
