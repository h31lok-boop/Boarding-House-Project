            ...
            <tbody class="divide-y divide-slate-100">
                <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-3 text-slate-700"><?php echo e($b['guest']); ?></td>
                        <td class="px-4 py-3 text-slate-700"><?php echo e($b['room']); ?></td>
                        <td class="px-4 py-3 text-slate-700"><?php echo e($b['dates']); ?></td>
                        <td class="px-4 py-3"><span class="px-2 py-1 text-xs rounded-full font-semibold <?php echo e($badge); ?>"><?php echo e($b['status']); ?></span></td>
                        <td class="px-4 py-3 space-x-2">
                            <form method="POST" action="<?php echo e(route('caretaker.bookings.confirm', $b['id'])); ?>" class="inline"><?php echo csrf_field(); ?><button class="px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-100 text-xs">Confirm</button></form>
                            <form method="POST" action="<?php echo e(route('caretaker.bookings.cancel', $b['id'])); ?>" class="inline"><?php echo csrf_field(); ?><button class="px-3 py-1 rounded-full bg-rose-50 text-rose-700 border border-rose-100 text-xs">Cancel</button></form>
                            <form method="POST" action="<?php echo e(route('caretaker.bookings.extend', $b['id'])); ?>" class="inline"><?php echo csrf_field(); ?><button class="px-3 py-1 rounded-full bg-indigo-50 text-indigo-700 border border-indigo-100 text-xs">Extend</button></form>
                        </td>
                    </tr>
...
<?php endif; ?>
<?php /**PATH C:\Users\Jay\Documents\GitHub\Boarding-House-Project\resources\views/caretaker/bookings.blade.php ENDPATH**/ ?>