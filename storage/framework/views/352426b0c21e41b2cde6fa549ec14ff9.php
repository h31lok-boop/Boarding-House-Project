...
<nav class="flex-1 space-y-4 text-sm sidebar-nav">
    <div>
        ...
        <a href="<?php echo e(route('tenant.dashboard')); ?>" class="<?php echo e(request()->routeIs('tenant.dashboard') ? $navActive : $navInactive); ?>">
    ...
    <div>
        ...
        <a href="<?php echo e(route('tenant.boarding-houses')); ?>" class="<?php echo e(request()->routeIs('tenant.boarding-houses') ? $navActive : $navInactive); ?>">
            <span class="sidebar-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.6" d="M3 10l9-7 9 7"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.6" d="M5 10v10h14V10"/></svg></span>
            <span class="sidebar-text">Boarding Houses</span>
        </a>
        <a href="<?php echo e(route('tenant.bh-policies')); ?>" class="<?php echo e(request()->routeIs('tenant.bh-policies') ? $navActive : $navInactive); ?>">
...
<?php /**PATH C:\Users\Jay\Documents\GitHub\Boarding-House-Project\resources\views/components/sidebar/tenant-panel.blade.php ENDPATH**/ ?>