...
test('admin sidebar highlights exactly one item on each admin sidebar page', function (string $path, string $activeKey) {
    ...
    'user management' => ['/admin/user-management', 'user-management'],
    'tenants' => ['/admin/tenants', 'user-management'],
    'legacy tenant profiles' => ['/admin/tenant-profiles', 'user-management'],
