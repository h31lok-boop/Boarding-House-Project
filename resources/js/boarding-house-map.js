...
const DEFAULT_MESSAGES = {
    ...
    geolocationDenied: 'Location access is blocked. Enable location permission in your browser or use the DSSC starting point.',
    routeFailed: 'Route information is temporarily unavailable. Please try again.',
    locationUnavailable: 'Your location could not be detected. Check your GPS or network connection.',
