            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('admin.boarding-houses.store') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input name="address" value="{{ old('address') }}" class="w-full border rounded-lg px-3 py-2" required>
                    </div>
                    <div>
                    ...
                    <div class="pt-2">
                        ...
                        <a href="{{ route('admin.boarding-houses.index') }}" class="ml-3 text-gray-600 hover:text-gray-800">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
