...
<x-admin.shell>
    <div x-data="{ composeOpen: false, selected: {} }" class="space-y-6">
        ...
        <div data-modal-root role="dialog" aria-modal="true" x-show="composeOpen" x-cloak @click.self="composeOpen = false" @keydown.escape.window="composeOpen = false" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
