        ...
        <div class="grid grid-cols-2 gap-2.5 sm:grid-cols-4 xl:grid-cols-7">
            <div data-admin-stat-card class="rounded-lg border border-slate-200/80 bg-white p-3 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        <p class="text-[10px] font-medium text-slate-500 dark:text-slate-300">Properties</p>
                        <p class="text-base font-bold text-slate-950 dark:text-white">{{ $totalProperties }}</p>
                    </div>
                </div>
            ...
            <div data-admin-stat-card class="rounded-lg border border-slate-200/80 bg-white p-3 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                <div class="flex items-center gap-2.5">
                    <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600 dark:bg-emerald-500/15 dark:text-emerald-300">
                    ...
                    <div>
                        <p class="text-[10px] font-medium text-slate-500 dark:text-slate-300">Occupancy</p>
                        <p class="text-base font-bold text-emerald-600 dark:text-emerald-300">{{ $occupancyRate }}%</p>
                    </div>
                </div>
                <div class="mt-1.5 h-1 overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                    <div class="h-full rounded-full bg-emerald-500 transition-all" style="width: {{ $occupancyRate }}%"></div>
                </div>
            </div>
            <div data-admin-stat-card class="rounded-lg border border-slate-200/80 bg-white p-3 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                <div class="flex items-center gap-2.5">
                    <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-violet-50 text-violet-600 dark:bg-violet-500/15 dark:text-violet-300">
                    ...
                    <div>
                        <p class="text-[10px] font-medium text-slate-500 dark:text-slate-300">Tenants</p>
                        <p class="text-base font-bold text-slate-950 dark:text-white">{{ $activeTenantCount }}</p>
                    </div>
                </div>
            ...
            <div data-admin-stat-card class="rounded-lg border border-slate-200/80 bg-white p-3 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        <p class="text-[10px] font-medium text-slate-500 dark:text-slate-300">Revenue</p>
                        <p class="text-base font-bold text-emerald-600 dark:text-emerald-300">₱{{ number_format($monthlyIncome) }}</p>
                    </div>
                </div>
                <p class="mt-1 text-[10px] text-emerald-600">↑ {{ $monthlyGrowth }}%</p>
            </div>
            <div data-admin-stat-card class="rounded-lg border border-amber-200/70 bg-amber-50/40 p-3 shadow-sm dark:border-amber-400/35 dark:bg-slate-900">
                <div class="flex items-center gap-2.5">
                    <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-amber-100 text-amber-600 dark:bg-amber-400/15 dark:text-amber-300">
                        <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5"/></svg>
                    </span>
                    <div>
                        <p class="text-[10px] font-medium text-amber-700 dark:text-amber-300">Pending</p>
                        <p class="text-base font-bold text-amber-800 dark:text-amber-300">{{ $resBreakdown['pending'] ?? 0 }}</p>
                    </div>
                </div>
                <p class="mt-1 text-[10px] text-amber-600 dark:text-amber-300">Reservations</p>
            </div>
            <div data-admin-stat-card class="rounded-lg border border-rose-200/70 bg-rose-50/40 p-3 shadow-sm dark:border-rose-400/35 dark:bg-slate-900">
                <div class="flex items-center gap-2.5">
                    <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-rose-100 text-rose-600 dark:bg-rose-400/15 dark:text-rose-300">
                    ...
                    <div>
                        <p class="text-[10px] font-medium text-rose-700 dark:text-rose-300">Unpaid</p>
                        <p class="text-base font-bold text-rose-800 dark:text-rose-300">₱{{ number_format($pendingAmount) }}</p>
                    </div>
                </div>
            ...
            <div data-admin-stat-card class="rounded-lg border border-blue-200/70 bg-blue-50/40 p-3 shadow-sm dark:border-blue-400/35 dark:bg-slate-900">
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        <p class="text-[10px] font-medium text-blue-700 dark:text-blue-300">Available</p>
                        <p class="text-base font-bold text-blue-800 dark:text-blue-300">{{ $availableRooms }}</p>
                    </div>
                </div>
                <p class="mt-1 text-[10px] text-blue-600 dark:text-blue-300">Rooms</p>
            </div>
        </div>
