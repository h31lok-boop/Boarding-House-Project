    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <button
                ...
                id="openAddRoomModal"
                data-store-url="{{ route('admin.rooms.store') }}"
            >
                ...
                <tbody id="roomTableBody" class="divide-y divide-gray-100">
                    @forelse($rooms as $room)
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-5 py-3 text-gray-900" data-room-col="house">{{ $houseName }}</td>
                            <td class="px-5 py-3 text-gray-700" data-room-col="no">{{ $room->room_no }}</td>
                            <td class="px-5 py-3 text-gray-700" data-room-col="description">{{ $room->description }}</td>
                            ...
                            <td class="px-5 py-3 text-right">
                                <div class="flex justify-end items-center gap-2">
                                    <button
                                        ...
                                        data-house-id="{{ $room->boarding_house_id }}"
                                        data-house-name="{{ $houseName }}"
                                        data-image="{{ $imageUrl }}"
                                        data-update-url="{{ route('admin.rooms.update', $room) }}"
                                        data-delete-url="{{ route('admin.rooms.destroy', $room) }}"
                                    >
                                        Edit
                                    </button>
                                    <button
