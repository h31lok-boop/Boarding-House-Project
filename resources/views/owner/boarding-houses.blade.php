    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <button
                ...
                data-store-url="{{ route('admin.boarding-houses.store') }}"
            >
                ...
                <tbody id="boardingHouseTableBody" class="divide-y divide-gray-100">
                    @forelse($houses as $house)
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-5 py-3 font-semibold text-gray-900">{{ $house->name }}</td>
                            <td class="px-5 py-3 text-gray-700">{{ $house->landlord_info ?? '' }}</td>
                            <td class="px-5 py-3 text-gray-700">{{ $house->address ?? '' }}</td>
                            <td class="px-5 py-3 text-right">
                                <div class="flex justify-end items-center gap-2">
                                    <button
                                        ...
                                        data-landlord="{{ $house->landlord_info ?? '' }}"
                                        data-address="{{ $house->address ?? '' }}"
                                        data-status="{{ $statusLabel }}"
                                        data-image="{{ $exteriorUrl }}"
                                        data-room="{{ $roomUrl }}"
                                        data-cr="{{ $crUrl }}"
                                        data-kitchen="{{ $kitchenUrl }}"
                                        data-monthly="{{ $house->monthly_payment ?? '' }}"
                                        data-update-url="{{ route('admin.boarding-houses.update', $house) }}"
                                        data-mode="view"
                                    >
                                        <span>View</span>
                                    </button>
