    ...
    <div class="space-y-6">
        <div class="ui-card p-6">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="{{ route('tenant.match-profile.edit') }}" class="rounded-lg border ui-border px-4 py-2 text-sm">Edit Match Profile</a>
                    <span class="rounded-full bg-indigo-50 px-4 py-2 text-sm font-medium text-indigo-700">{{ $matchCount }} eligible candidates</span>
                </div>
            </div>
        </div>
        ...
        @if ($matches->isEmpty())
            <div class="ui-card p-8 text-center">
                ...
                <p class="mt-2 text-sm ui-muted">Once other tenants complete their match profiles, recommendations will show up here.</p>
            </div>
        @else
                ...
                @foreach ($matches as $match)
                    ...
                    <article class="ui-card p-6 space-y-5">
                        ...
                        <div class="flex justify-end gap-3">
                            ...
                            <a href="{{ route('tenant.matches.show', $candidate) }}" class="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-500">View Full Match</a>
                        </div>
                    </article>
                @endforeach
            </div>
