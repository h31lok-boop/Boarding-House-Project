        ...
        <div class="p-6">
          ...
          <div class="space-y-3 text-sm">
            ...
            @if ($currentBooking)
              ...
              <p class="text-sm ui-muted">Need changes? Contact management for updates.</p>
      ...
      <div class="lg:col-span-2 ui-card">
        <div class="p-6">
          <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('user.recommendations') }}" class="px-3 py-2 rounded-lg border ui-border text-sm">Open Recommendations</a>
          </div>
        ...
        <div class="p-6">
          ...
          <div class="space-y-3 text-sm">
            @if ($pendingIncomingMatchRequests > 0)
              ...
              <a href="{{ route('user.recommendations') }}" class="inline-flex px-3 py-2 rounded-lg bg-indigo-600 text-white text-sm">Review Requests</a>
            @elseif ($acceptedMatchRequests > 0)
              ...
              <a href="{{ route('user.recommendations') }}" class="inline-flex px-3 py-2 rounded-lg bg-indigo-600 text-white text-sm">View Matches</a>
            @else
              ...
              <a href="{{ route('user.recommendations') }}" class="inline-flex px-3 py-2 rounded-lg bg-indigo-600 text-white text-sm">Find Roommates</a>
            @endif
          </div>
        </div>
      </div>
          ...
          <tbody class="divide-y divide-gray-100">
            ...
            @forelse($housemates as $mate)
              ...
              <tr class="bg-slate-50">
                ...
                <td class="px-5 py-3 capitalize">{{ $mate->roles->pluck('name')->first() ?? $mate->role ?? 'user' }}</td>
