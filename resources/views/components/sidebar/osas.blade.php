...
<nav class="space-y-1 text-sm font-medium text-gray-700">
    @foreach ($links as $link)
        ...
        <a
            ...
            class="flex items-center gap-2 px-3 py-2 rounded-lg border {{ $isActive ? 'bg-purple-50 text-purple-800 border-purple-100' : 'border-transparent hover:bg-gray-50 text-gray-700' }}"
        >
