...
<nav class="flex-1 space-y-4 text-sm sidebar-nav">
    ...
    <div>
        ...
        <a href="{{ route('admin.users') }}" class="{{ request()->routeIs('admin.users*') ? $navActive : $navInactive }}">
        ...
        <a href="{{ route('admin.boarding-houses.index') }}" class="{{ request()->routeIs('admin.boarding-houses.*') ? $navActive : $navInactive }}">
        ...
        <a href="{{ route('admin.applications.index') }}" class="{{ request()->routeIs('admin.applications.*') ? $navActive : $navInactive }}">
        ...
        <a href="{{ route('admin.tenant-history') }}" class="{{ request()->routeIs('admin.tenant-history') ? $navActive : $navInactive }}">
    ...
    <div>
        ...
        <a href="{{ route('admin.boarding-house-policies.index') }}" class="{{ request()->routeIs('admin.boarding-house-policies.*') ? $navActive : $navInactive }}">
