...
>
    ...
    <div
        data-modal-panel
        x-show="show"
        class="my-auto w-full overflow-hidden rounded-lg bg-white text-slate-900 shadow-xl transform transition-all dark:bg-slate-900 dark:text-slate-100 sm:mx-auto {{ $maxWidth }}"
        x-transition:enter="ease-out duration-300"
