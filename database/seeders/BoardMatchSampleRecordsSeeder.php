    ...
    private function seedNotifications(
        ...
        $rows = [
            ...
            [
                ...
                'message' => 'Your PHP 4,200 rent for Mintal Corner Boarding House is already overdue. Please pay in cash at the front desk to avoid penalties.',
            ...
            [
                ...
                'message' => 'A cash payment receipt from Angelica Mae Cabug is waiting for verification in the transactions queue.',
    ...
    private function paymentBlueprints(): array
    {
        return [
            'tenant_john' => [
                ...
                'due_days_ago' => 160,
                'paid_days_ago' => 158,
                'notes' => 'January rent settled in cash before room endorsement.',
            ],
            'tenant_princess' => [
                'house_key' => 'house_alvarado',
                'amount' => 3000,
                ...
                'due_days_ago' => 145,
                'paid_days_ago' => 144,
                'notes' => 'February rent posted in cash at the front desk.',
            ],
            'tenant_mark' => [
                'house_key' => 'house_alvarado',
                'amount' => 2800,
    ...
    private function transactionBlueprints(): array
    {
        return [
            'tenant_john' => [
                ...
                'transaction_id' => 'CASH-2601-448211',
                'status' => 'approved',
            ...
            'tenant_princess' => [
                ...
                'transaction_id' => 'CASH-2602-118304',
                'status' => 'approved',
                'payment_days_ago' => 144,
                'reviewed_days_ago' => 143,
                'rejection_reason' => null,
                'notes' => 'February rent receipt for a cash payment.',
            ],
            'tenant_mark' => [
                'house_key' => 'house_alvarado',
                'amount' => 2800,
                ...
                'transaction_id' => 'CASH-2603-741028',
            ...
            'tenant_jessa' => [
                ...
                'transaction_id' => 'CASH-2604-551992',
                'status' => 'rejected',
            ...
            'tenant_angelica' => [
                ...
                'transaction_id' => 'CASH-2606-400715',
                'status' => 'pending_review',
                'payment_days_ago' => 69,
                'reviewed_days_ago' => null,
                'rejection_reason' => null,
            ...
            'tenant_renz' => [
                ...
                'transaction_id' => 'CASH-2607-818244',
                'status' => 'rejected',
                'payment_days_ago' => 55,
                'reviewed_days_ago' => 54,
                'rejection_reason' => 'Transfer reference did not match the amount posted in the billing record.',
                'notes' => 'Advance payment receipt was rejected because the recorded cash details did not match.',
            ],
            'tenant_shaina' => [
                'house_key' => 'house_candelaria',
                'amount' => 5500,
                ...
                'transaction_id' => 'CASH-2608-922650',
                'status' => 'approved',
                'payment_days_ago' => 39,
            ...
            'tenant_carlo' => [
                ...
                'transaction_id' => 'CASH-2609-633901',
                'status' => 'pending_review',
                'payment_days_ago' => 18,
                'reviewed_days_ago' => null,
                'rejection_reason' => null,
            ...
            'tenant_lovely' => [
                ...
                'transaction_id' => 'CASH-2610-777315',
                'status' => 'approved',
                'payment_days_ago' => 7,
                'reviewed_days_ago' => 6,
                'rejection_reason' => null,
