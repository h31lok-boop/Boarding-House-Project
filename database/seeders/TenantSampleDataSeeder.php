    ...
    private function ensurePayments(?int $tenantId, ?int $tenancyRecordId, BoardingHouse $house): void
    {
        ...
        $payments = [
            [
                ...
                'amount' => 3500,
                'due_date' => $this->dateWithDay(now()->subMonthNoOverflow(), 5)->toDateString(),
                'payment_date' => $this->dateWithDay(now()->subMonthNoOverflow(), 4)->toDateString(),
                'paid_at' => $this->dateWithDay(now()->subMonthNoOverflow(), 4)->setTime(10, 30)->toDateTimeString(),
                'status' => 'confirmed',
                'payment_type' => 'rent',
                'payment_method' => 'gcash',
                'confirmed_by' => $house->approved_by,
                'confirmed_at' => now()->subMonthNoOverflow()->toDateTimeString(),
                'is_late' => false,
                'penalty_amount' => 0,
                'notes' => 'Sample paid monthly rent.',
            ],
            [
                'reference_no' => 'PAY-HAZEL-002',
                'reference_number' => 'PAY-HAZEL-002',
                'amount' => 3500,
                'due_date' => $this->dateWithDay(now(), 5)->toDateString(),
                ...
                'payment_method' => 'gcash',
                'is_late' => now()->day > 5,
                'penalty_amount' => now()->day > 5 ? 150 : 0,
            ...
            [
                ...
                'amount' => 3500,
                'due_date' => $this->dateWithDay(now()->addMonthNoOverflow(), 5)->toDateString(),
                'payment_date' => now()->toDateString(),
                'paid_at' => null,
                'status' => 'pending',
                'payment_type' => 'rent',
