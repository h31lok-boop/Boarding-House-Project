...
class OpenAIService
{
    ...
    private function buildBoardingHousePrompt(array $payload): string
    {
        return implode("\n", [
            ...
            '- When result_type is match, mention the strongest preference matches and any meaningful limitation.',
            '- When result_type is suggestion, explicitly call it a suggestion rather than a preference match. Explain only the supplied rating, features, availability, and suggestion_reasons.',
