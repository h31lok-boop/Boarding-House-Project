...
class TenantMatchProfileUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'social_style' => ['required', Rule::in(['talkative', 'balanced', 'introvert'])],
            'cooking_habit' => ['required', Rule::in(['enjoys_cooking', 'occasional_cooking', 'rarely_cooks'])],
            'work_schedule' => ['required', Rule::in(['day_schedule', 'flexible_schedule', 'night_shift'])],
            'guest_preference' => ['required', Rule::in(['no_guests', 'occasional_guests', 'guests_welcome'])],
            'sharing_style' => ['required', Rule::in(['shares_easily', 'ask_first', 'personal_space'])],
